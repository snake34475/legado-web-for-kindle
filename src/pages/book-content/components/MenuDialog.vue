  ...
  <div class="menu-dialog" :class="{ visible }">
    ...
    <div class="menu">
      <div class="menu-item buttons">
        <button class="custom-button" @click="emits('pre-chapter')">
          上一章
        </button>
        <button class="custom-button" @click="emits('next-chapter')">
          下一章
        </button>
      ...
      <div class="menu-item font-size">
        ...
        <div class="control">
          <button class="custom-button" @click="state.config.fontSize--">
            减小
          </button>
          <button class="custom-button" @click="state.config.fontSize++">
            增大
      ...
      <div class="menu-item font-size">
        ...
        <div class="control">
          <label for="always-next-page"
            >始终下一页(点左边/右边都是下一页)</label
          >
          <input
      ...
      <div class="menu-item font-size">
        <div class="name">
          <span :style="fontStyle">缓存章节：</span>
        </div>
        <div class="control">
          <select class="custom-select" v-model="state.config.cacheChapter">
      ...
      <div class="hint">
        ...
        <ul>
          ...
          <li>
            修改字体：如过刚打开浏览器没多久，需要等一段时间字体才能加载完，才能生效
          </li>
          <li>
